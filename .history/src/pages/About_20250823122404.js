          ...
          >
            ...
            >
              ...
              >
                ...
                <strong className="text-coral"> React Native</strong>,
                <strong className="text-coral"> TypeScript</strong>, integrating the
                <strong className="text-coral"> OpenSheetMusicDisplay API</strong> with a
                <strong className="text-coral"> Dynamic Time Warping algorithm</strong> for
                real-time audio-to-score alignment
                . I also developed an AI-powered chatbot for
                <strong className="text-coral"> Wabash National&apos;s</strong> website to cut
                reliance on call centers, and redesigned the
